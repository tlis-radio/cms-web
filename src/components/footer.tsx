"use client"; // Pridajte, ak Footer nepoužívate výhradne v serverových komponentoch
...
// Custom playlist icon definition zostáva nezmenená
               ...
               <div className="flex justify-center md:justify-end">
                  <Socials mobile={'both'}
                     additionalLinks={[
                        ...
                        { icon: faSpotify, url: "https://open.spotify.com/user/radiotlis" },
            ...
            <div className="mt-8 border-t border-gray-800 pt-6">
               <div className="flex flex-col md:flex-row items-center justify-between gap-3">
                  <p className="text-sm text-gray-500">
                     © {new Date().getFullYear()} Radio TLIS. {t('rights')} | <a href="https://webenta.sk" className="hover:underline">Webové služby Webenta</a>
                  </p>
                  <p className="text-sm text-gray-500 italic">strictly alternative</p>
               </div>
            </div>
         </div>
      </footer>
